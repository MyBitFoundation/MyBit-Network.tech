...
contract('WithdrawalManager - Deploying and storing all contracts + validation', async (accounts) => {
   ...
   */
   it('Add dummy account as a contract', async () => {
     ...
     assert.equal(await apiInstance.contractAddress('TestContractMimic'), ownerAddr1);
